...
contract FAYC is ERC721, ERC721Enumerable, Ownable {
    using Counters for Counters.Counter;
 
    Counters.Counter private _tokenIdCounter;
    address public minterContract;
    uint16 public MAX_SUPPLY = 20;
    ...
    constructor(string memory baseTokenURI, string memory _initNotRevealedUri) ERC721("BoltApeYC", "BAYC") {
